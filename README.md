# Input Field Sample Application
...
This is a sample vanilla [react](https://reactjs.org/) application which demonstrates basic state management with input validation.
...
Click [here](https://input-field-sample-vanilla-ygxpeixvfb.now.sh) to see it running.
